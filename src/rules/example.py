...
def create_example_game_state():
    ...
    players = [
        # Team 1 players
        Player(id=1, position=Position(x1=4.5, x2=5.5, y1=2.5, y2=3.5), team=1, height=2.0),
        Player(id=2, position=Position(x1=6.5, x2=7.5, y1=4.5, y2=5.5), team=1, height=1.95),
        Player(id=3, position=Position(x1=5.5, x2=6.5, y1=7.5, y2=8.5), team=1, height=2.05),
        Player(id=4, position=Position(x1=3.5, x2=4.5, y1=9.5, y2=10.5), team=1, height=1.90),
        Player(id=5, position=Position(x1=7.5, x2=8.5, y1=11.5, y2=12.5), team=1, height=2.10),
        
        # Team 2 players
        Player(id=6, position=Position(x1=19.5, x2=20.5, y1=2.5, y2=3.5), team=2, height=2.0),
        Player(id=7, position=Position(x1=21.5, x2=22.5, y1=4.5, y2=5.5), team=2, height=1.95),
        Player(id=8, position=Position(x1=20.5, x2=21.5, y1=7.5, y2=8.5), team=2, height=2.05),
        Player(id=9, position=Position(x1=18.5, x2=19.5, y1=9.5, y2=10.5), team=2, height=1.90),
        Player(id=10, position=Position(x1=22.5, x2=23.5, y1=11.5, y2=12.5), team=2, height=2.10),
    ]
